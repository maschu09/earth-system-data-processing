...
- is_day_processed(day, function): This returns a Boolean value indicating whether a day has been processed. This information is based on whether a folder exists for the date in question and whether there exists a flag 'done' for downloaded data as well as 'interpolated' for interpolated data.
